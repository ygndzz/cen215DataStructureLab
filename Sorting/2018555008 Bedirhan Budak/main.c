...
int main() {
	...
	int number0[] = { 2,0,1,8,5,5,5,0,0,8 };
	int number0Size = sizeof(number0) / sizeof(number0[0]);
	printf("My number is: 2018555008\n");

	int name0[] = { 'b','e','d','i','r','h','a','n' };
	int name0Size = sizeof(name0) / sizeof(name0[0]);
	printf("My name is: bedirhan\n\n");
	...
	printf("Bubble Sort took %f seconds to sort and my number\n\n", ((double)time) / CLOCKS_PER_SEC);
	time = clock();
	...
	//Definitions
	int number1[] = { 2,0,1,8,5,5,5,0,0,8 };
	int number1Size = sizeof(number1) / sizeof(number1[0]);

	int name1[] = { 'b','e','d','i','r','h','a','n' };
	...
	//Definitions
	int number2[] = { 2,0,1,8,5,5,5,0,0,8 };
	int number2Size = sizeof(number2) / sizeof(number2[0]);

	int name2[] = { 'b','e','d','i','r','h','a','n' };
	...
	//Definitions
	int number3[] = { 2,0,1,8,5,5,5,0,0,8 };
	int number3Size = sizeof(number3) / sizeof(number3[0]);

	int name3[] = { 'b','e','d','i','r','h','a','n' };
	...
	//Definitions
	int number4[] = { 2,0,1,8,5,5,5,0,0,8 };
	int number4Size = sizeof(number4) / sizeof(number4[0]);

	int name4[] = { 'b','e','d','i','r','h','a','n' };
	...
	//Definitions
	int number5[] = { 2,0,1,8,5,5,5,0,0,8 };
	int number5Size = sizeof(number5) / sizeof(number5[0]);

	int name5[] = { 'b','e','d','i','r','h','a','n' };
