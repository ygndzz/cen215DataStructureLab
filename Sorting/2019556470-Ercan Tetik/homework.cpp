...
int main() {
	...
	printf("My name is Ercan Tetik.\n My number is 2019556470.\n");
	int selectionnum[] = { 2,0,1,9,5,5,6,4,7,0 };
	char selectionname[] = "Ercan Tetik";
	...
	int bubblenum[] = { 2,0,1,9,5,5,6,4,7,0 };
	char bubblename[] = "Ercan Tetik";
	...
	int mergenum[] = { 2,0,1,9,5,5,6,4,7,0 };
	char mergename[] = "Ercan Tetik";
	...
	int insertionnum[] = { 2,0,1,9,5,5,6,4,7,0 };
	char insertionname[] = "Ercan Tetik";
...
int quicksortnum[] = { 2,0,1,9,5,5,6,4,7,0 };
	char quicksortname[] = "Ercan Tetik";
	...
	int heapsortnum[] = { 2,0,1,9,5,5,6,4,7,0 };
	char heapsortname[] = "Ercan Tetik";
